...
# definiujemy funkcje, która będzie zliczać sumę elementów naszej listy przekazanej do funkcji
...
# -- 2 sposób na pokazanie sumy - dekomponuemy na mniejsze elementy: dajemy zmienną 'numbers', gdzie przypiszemy listę
...
# print (generate_numbers(10)) # używamy naszej funkcji 'generate_numbers' za pomocą ktorej
# (oczywiście zeby się te liczby wylosowane wyświetliły, musimy uzyć funkcji drukującej 'print')
...
# przyklad 1 - tylko zmienna lokalna x, której wartość bez funkcji print się nie wyświetli
...
# przykład 1' - też tylko zmienna lokalna x, ale już z funkcją print w ciele funkcji i dzięki temu jej wartość się wyświetli
# def scope_test (): # ma jedną zmienną lokalką x - to jest x poniżej
#     x = 123
#     print(x)
# scope_test() # to jest uruchomienie tej funkcji - dzuiala ale sie nic nie pojawia , bo retiurn zwraca wartosc, a nie pokazjuje jak print
...
# przyklad 2--------- Wyświetlenie zmiennej globalnej w ciele funkcji (w przypadku, gdy nie ma zmiennej lokalnej, a nazwa zmiennej
# globalnej została użyta w ciele funkcji)
# def scope_test (): # ma jedną zmienną globalną x - to jest x poniżej, która jesli nie ma zmiennej lokalne a ma taką samą nazwę
    # zmiennej jak w ciele funkcji, to ją wyświetli
...
# przyklad 2'--------- Pierwszenstwo dla wyświetlenie zmiennej lokalnej, zamiast globalnej, gdzie zmienne mają tą samą nazwę,
# ale funkcja print jest w ciele funckji
# def scope_test ():
#     x = 8 # to jest zmienna lokalna,która się wyświetli
#     print(" wsrodku funkji:" + str(x))
...
# # przyklad 3------- ZASIĘG ZMIEnnych CD. - przewaga zmiennej loklanej nad globalną, dla fukcji print w ciele funkcji
# oraz wyswietlenie zmiennej globalnej za pomocą globalnej funkcji print
# def scope_test (): # definujemy funkcje o nazwie scope_test ,  ma ona jedną zmienną lokalną x - to jest x poniżej,
...
# val = [1,2] # do tej zmiennej globalnej przeakuzjemy liste
# change_value(val) # za pomocą tej change_value mozemy zmienić wartość listy 'val=[1,2] - i następnie program przekazuje do piewrszej linii ,
# tam gdzie funkcja change_value jest opisana , nawet jak jest n ale tu już jest val i to wchodzi zamiast n
# print(val)
