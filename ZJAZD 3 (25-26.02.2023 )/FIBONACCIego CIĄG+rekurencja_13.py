...
# dwa pierwsze elementy są równe 1, które są stale, a potem kolejne elementy są tworzone na podstawie poprzedzających - jest to suma,
# czyli 1, 1, 2(1+1), 3 (2+1), 5 (3+2), 8 (5+3), 13 (8+5), 21 (13+8), 34 (21+13) ....
...
#         return 1
    ...
    # for i in range(3, n+1):# a teraz w pętli for, w zakresie od 3 do n+1=kolejne element, zgodny z funkcją range-musi się zwiększać (bo wiadomo, że nie interesuje nas ani element pierwszy, ani drugi,
#     które na sztywno w ciągu fibonacciego mają 1) dojeśli ktoś poda więcej niż 1 dla elementy od b tu od 3 zaczynamy wyliczać Ciąg Fibonacciego
