...
dice_rolls_total = 16 #definuijemy stałą, w któej będziemy przechowywać ilośc rzytów kostką - ma być 16
rolls = [] # tu przechwujemy listę wylosowanych oczek

for i in range (dice_rolls_total):
    rolls.append(random.randint(1, 6))
print ("Zbior wyników po", dice_rolls_total, "rzutach kostką do gry:", rolls) # to jest podpunk 1
...
# podpunkt 3
sixes_total = 0 # na początku tą zmienną pomicniczą ustawiamy na 0
for roll in rolls:
    if roll == 6:
