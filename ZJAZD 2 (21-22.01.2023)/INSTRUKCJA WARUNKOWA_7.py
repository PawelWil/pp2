...
# a, b = 11, 9 # przypisujemy wartości zmiennych w jednym wierszu, ale jest dużo mniej czytelny. Dużo bardziej czytelnie jest,
# gdy to robimy w kazdym soobnym wierszu - tu a = 11, zaś b = 9
# print (a >= b) # oczywiscie true

# print (2 == 2)
# print (2 = 2.) # tu w informacji błedu dostaniemy info, że musimy dać operator == -->
...
# wciecia musimy stossowac konsekwetnie - wcięcia mozemy robić za pomocą spacji i tabulatora, ale trza wybrać jedną wersję,
# czy to będzie tab, czy spacja. Ale najlepiej dawać tabulator
# jeśli chcemy spacje do wcięć, to ich ilość zawsze musi być taka sama,
# inaczej będą błędy, dlatego tabulator jest najlepszy, bo nam zawsze ustawi 4 spacje!
...
number = random.randint(1,
                        3)  # ona nam losuje liczbę z przedziału jaki jej podamy, czyli w naszym przypadku, z przdziału od 1 do 3

guess = int(input(
    "Zgadnij jaką liczbę mam na myśli (chodzi o: 1, 2 lub 3) : "))  # zmienna która nam poda jaka liczbę mamy na mysli
